...
$('.landing_slider').slick({
  ...
  autoplay: true,
  autoplaySpeed: 3000,
  prevArrow: '<span class="prev_arrow_l d-none d-md-block"><i class="fa-solid fa-angle-left m-auto"></i></span>',
  nextArrow: '<span class="next_arrow_l d-none d-md-block"><i class="fa-solid fa-angle-right m-auto"></i></span>',
  responsive: [
    {
      breakpoint: 1400,
      settings: {
